...
export default class CameraScreenBase extends Component {
			...
			<View style={styles.cameraContainer}>
				{this.isCaptureRetakeMode() ? (
					...
					<CameraKitCamera
						...
						heightFrameScreen={this.props.frameHeight}
						widthFrameScreen={this.props.frameWidth}
						offsetYFrameScreen={this.props.offsetHeight}
					/>
				)}
			</View>
		);
	...
	renderBottomButtonsFrame() {
		return (
			!this.props.hideControls && (
				<SafeAreaView style={styles.bottomButtonsFrame}>
					{this.renderBottomButton('left')}
					{this.renderCaptureButton()}
					{this.renderBottomButton('right')}
				</SafeAreaView>
